...
namespace :test do
  ...
  task riscv_vector_tests: ["build_riscv_tests", "build:iss"] do
    ...
    uvTests = ["vsetivli", "vsetvl", "vsetvli_rs1_eq_zero", "vsetvli_vl_lt_vlmax",
                ...
                "vle_vse_widths", "vmv_merge", "vint_arith", "vmul_mac", "vcmp_mask", "vshift_widen", "vwiden_extra", "vphase_gaps", "vred_perm", "vcarry", "vmem_phase10", "vfp64", "vsat_addsub", "vsmul", "vxsat_roundtrip", "vsat_shift", "vnclip"]
